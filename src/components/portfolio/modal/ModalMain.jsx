...
import ModalSimple from "./modal-by-id/Modalsimple";
import ModalDescription from "./modal-by-id/ModalDescription";
...
const ModalMain = ({ modalId, setGetModal }) => {
  ...
  else if (modalId.includes('simple')) {
    return (
      <ModalSimple modalId={modalId} setGetModal={setGetModal}/>
    );
  }
  else if (modalId.includes('slider')) {
    return (
      <ModalThree modalId={modalId} setGetModal={setGetModal}/>
    );
  }   
  else if (modalId.includes('desc')) {
    return (
      <ModalDescription modalId={modalId} setGetModal={setGetModal}/>
    );
  }    
};
